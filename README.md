# MAE116 - Metodos Matematicos em Biologia I

Esse repositório contem as notas e outros documentos para as aulas do curso MAE116 Métodos Matemáticos em Biologia I do curso de Biofísica na UFRJ.

O curso é desenvolvido para estudantes do primeiro periodo de Graduação de Biofísica.

Professor : Dr. Arthur Roman Hardiagon, whatsapp : 21 998428112
...
| Nota | Data  | Tipo | Valor | Coeficiente |
|------|-------|------|-------|-------------|
...
1: 4,5; 2:3,0; 3:8,5, 4:6,5; FINAL:7,0 

$$
\frac{4,5\cdot 1+8,5\cdot 1 + 6,5 \cdot 1 + 7,0\cdot 3  }{1+1+1+3} = 6.75  
$$

## Bibliografia

### Livro fundamental
- Cálculo, Volume I, Tradução da 7a Ed. norte-americana, James Stewart Editora: CENGAGE-
Learning

[Em português, com exercícios, o livro tem uma visão moderna da matemática com exemplos concretos extraídos de outros campos científicos, bem como abordagens históricas.]

### Outras referências
- George B. Thomas, Jr., Thomas’Calculus Early Transcendentals, 12th Edition, MIT

[Em inglès, segui a mesma progressão do Stewart mas tem outros exercícios, é bom para trainar com o inglès ciéntifico]

- Sonia P., Bean. Matemática Elementar para Biocientistas, 2a edição, Universidade Federal de Santa Catarina

[Em português, menos avançado, o livro revisa os conceitos matemáticos do ensino médio usando exemplos da biologia.]
